...
{
  value: "tuoitruckhitrong",
  label: "Tuổi cây lúc trồng (năm)",
  table: {
    visible: false,
    sortable: true
  },
...
{
  value: "DK_Thoidiem_trong",
  label: "Đường kính tại thời điểm trồng (cm)",
  table: {
    visible: false,
    sortable: true
  },
...
{
  value: "cao_thoidiemtrong",
  label: "Chiều cao cây tại thời điểm trồng (m)",
  table: {
    visible: false,
    sortable: true
  },
...
{
  value: "supst_cond",
  label: "Phân loại theo chiều cao (năm)",
  table: {
    visible: false,
    sortable: true
  },
...
{
  value: "deck_cond",
  label: "Phân loại theo đường kính (cm)",
  table: {
    visible: false,
    sortable: true
  },
...
// Basemap Layers
var mapboxOSM = L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}", {
  maxZoom: 19,
  subdomains: ["a", "b", "c", "d"],
  attribution: 'Basemap <a href="" target="_blank">© Mapbox © OpenStreetMap</a>'
});

var mapboxSat = L.tileLayer("https://mt1.google.com/vt/lyrs=y&hl=vi&x={x}&y={y}&z={z}", {
  maxZoom: 19,
  subdomains: ["a", "b", "c", "d"],
  attribution: 'Basemap <a href="" target="_blank">© Mapbox © OpenStreetMap</a>'
});
